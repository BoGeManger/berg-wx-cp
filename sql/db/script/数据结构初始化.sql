...
-- ----------------------------
-- Table structure for cp_media_tbl
-- ----------------------------
DROP TABLE IF EXISTS `cp_media_tbl`;
CREATE TABLE `cp_media_tbl`  (
`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '微信企业号素材表id',
`app_id` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '微信公众号corpId',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信企业号素材表' ROW_FORMAT = Dynamic;
